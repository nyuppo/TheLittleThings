...
public class TheLittleThingsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutoutMipped(),
                ...
                ModBlocks.PINK_CARNATION, ModBlocks.RED_CARNATION, ModBlocks.WHITE_CARNATION, ModBlocks.CROCUS, ModBlocks.HELICONIA, ModBlocks.YUCCA, ModBlocks.CRILLEA, ModBlocks.EKO,
                ModBlocks.POTTED_PINK_CARNATION, ModBlocks.POTTED_RED_CARNATION, ModBlocks.POTTED_WHITE_CARNATION, ModBlocks.POTTED_CROCUS, ModBlocks.POTTED_HELICONIA, ModBlocks.POTTED_YUCCA, ModBlocks.POTTED_CRILLEA, ModBlocks.POTTED_EKO,
                ModBlocks.OAK_TABLE, ModBlocks.SPRUCE_TABLE, ModBlocks.BIRCH_TABLE, ModBlocks.JUNGLE_TABLE, ModBlocks.DARK_OAK_TABLE, ModBlocks.ACACIA_TABLE, ModBlocks.MANGROVE_TABLE, ModBlocks.CRIMSON_TABLE, ModBlocks.WARPED_TABLE, ModBlocks.BAMBOO_TABLE, ModBlocks.SAKURA_TABLE, ModBlocks.AZALEA_TABLE, ModBlocks.WILLOW_TABLE, ModBlocks.BAOBAB_TABLE);
