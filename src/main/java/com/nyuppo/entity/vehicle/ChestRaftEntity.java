...
public class ChestRaftEntity extends RaftEntity implements RideableInventory, VehicleInventory {
    ...
    public ChestRaftEntity(EntityType<? extends RaftEntity> entityType, World world) {
        super(entityType, world);
        this.inventory = DefaultedList.ofSize(27, ItemStack.EMPTY);
    }

    public ChestRaftEntity(World world, double d, double e, double f) {
        this(ModEntityTypes.CHEST_RAFT, world);
    ...
    public Item asItem() {
        ...
        switch(this.getRaftType()) {
            case BAMBOO:
            default:
                var10000 = ModItems.BAMBOO_CHEST_RAFT;
        }
